...
var scroll_1 = __webpack_require__(60);
...
var linked_list_1 = __webpack_require__(62);
...
module.exports = {
  ...
  'italic': __webpack_require__(102),
  'image': __webpack_require__(100),
  'indent': {
    '+1': __webpack_require__(101),
    '-1': __webpack_require__(107)
  },
  'link': __webpack_require__(103),
  'list': {
    'ordered': __webpack_require__(106),
    'bullet': __webpack_require__(104),
    'check': __webpack_require__(105)
  },
  'script': {
    'sub': __webpack_require__(109),
    'super': __webpack_require__(110)
  },
  'strike': __webpack_require__(108),
  'underline': __webpack_require__(111),
  'video': __webpack_require__(112)
};
...
var ImagePopup = function () {
	function ImagePopup(quill) {
		...
		btnInsert.onclick = function (e) {
			e.preventDefault();
			if (rdURL.checked) {
				_this.addFromURL(txtURL.value);
			} else {
				if (inputFile.files != null && inputFile.files[0] != null) {
					_this.addFromFile(inputFile.files[0]);
				}
			}
		};
	...
	_createClass(ImagePopup, [{
		...
		key: "addFromFile",
		value: function addFromFile(imageFile) {
			var _this2 = this;
			...
			ImageUpload.upload(imageFile, function (error) {
				if (error) {
					alert(error);
				}
				_this2.hide();
			}, function (progress) {
				_this2.progressBar.style.width = progress * 100 + "%";
				_this2.progressBar.innerHTML = Math.round(progress * 100) + "%";
			});
...
var _imagePopup = __webpack_require__(30);
...
var _imageResizer = __webpack_require__(80);
...
var SIZES_PT = [false, '10pt', '12pt', '14pt', '18pt', '24pt'];
...
var BaseTheme = function (_Theme) {
  ...
  function BaseTheme(quill, options) {
    ...
    _this.imageResizer = new _imageResizer2.default(quill);
    ...
    var listener = function listener(e) {
      ...
      if (_this.imageResizer != null) {
        if (e.target.tagName == "IMG" && quill.root.contains(e.target)) {
          _this.imageResizer.controlImage(e.target);
        } else if (!_this.imageResizer.root.contains(e.target)) {
          _this.imageResizer.hide();
        }
      }
    };
    document.body.addEventListener('click', listener);
    quill.on("text-change", function () {
      if (_this.imageResizer && _this.imageResizer.active) {
        if (quill.root.contains(_this.imageResizer.image)) {
          _this.imageResizer.updatePosition();
        } else {
          _this.imageResizer.hide();
        }
      }
...
var _sizePt = __webpack_require__(72);
...
var _underline = __webpack_require__(74);
...
var _imageUpload = __webpack_require__(77);
...
var _snow = __webpack_require__(64);
...
_core2.default.register({
  ...
  'attributors/style/size-pt': _sizePt.SizeStylePt
}, true);
...
_core2.default.register({
  ...
  'formats/size-pt': _sizePt.SizeStylePt,
  ...
  'modules/image-upload': _imageUpload2.default,
  ...
  'ui/image-popup': _imagePopup2.default
}, true);
      ...
      handlers: {
        link: function link(value) {
          if (value) {
            ...
            if (/^\S+\.\S{2,3}\b$/.test(preview) && preview.indexOf('http://') !== 0 && preview.indexOf('https://') !== 0) {
...
var SizeStylePt = new _parchment2.default.Attributor.Style('size-pt', 'font-size', {
  scope: _parchment2.default.Scope.INLINE,
  whitelist: ['10pt', '12pt', '14pt', '18pt', '24pt']
});

exports.SizeStylePt = SizeStylePt;
...
var UPLOAD_API_URL = "http://victorbreder.com/qmagico/upload.php";

var ImageUpload = function (_Module) {
	_inherits(ImageUpload, _Module);

	function ImageUpload(quill, options) {
		_classCallCheck(this, ImageUpload);

		return _possibleConstructorReturn(this, (ImageUpload.__proto__ || Object.getPrototypeOf(ImageUpload)).call(this, quill, options));
	}

	_createClass(ImageUpload, [{
		key: 'upload',
		value: function upload(image_file, done_callback, progress_callback) {
			var _this2 = this;
			...
			fileReader.onload = function (e) {
				...
				post(UPLOAD_API_URL, { key: key, name: name, md5: md5, base64: base64 }, function (res) {
					if (res.error == null) {
						var selection = _this2.quill.getSelection(true);
						_this2.quill.insertEmbed(selection.index, "image", res.data.url);
						if (done_callback) {
							done_callback();
						}
					} else {
...
var ImageResizer = function () {
    ...
    _createClass(ImageResizer, [{
        ...
        value: function createControls() {
            ...
            var startResize = function startResize(e) {
                ...
                if (!resizing && _this.image != null) {
                    ...
                    startWidth = _this.image.offsetWidth;
                    startHeight = _this.image.offsetHeight;
                    ratio = startWidth / startHeight;
                }
            };
            topLeft.onmousedown = function (e) {
                resizingLeft = true;
                resizingTop = true;
                startResize(e);
            };
            topLeft.addEventListener("touchstart", function (e) {
                resizingLeft = true;
                resizingTop = true;
                startResize(e);
            });
            topRight.onmousedown = function (e) {
                resizingLeft = false;
                resizingTop = true;
                startResize(e);
            };
            topRight.addEventListener("touchstart", function (e) {
                resizingLeft = false;
                resizingTop = true;
                startResize(e);
            });
            bottomLeft.onmousedown = function (e) {
                resizingLeft = true;
                resizingTop = false;
                startResize(e);
            };
            bottomLeft.addEventListener("touchstart", function (e) {
                resizingLeft = true;
                resizingTop = false;
                startResize(e);
            });
            bottomRight.onmousedown = function (e) {
                resizingLeft = false;
                resizingTop = false;
                startResize(e);
            };
            bottomRight.addEventListener("touchstart", function (e) {
                resizingLeft = false;
                resizingTop = false;
                startResize(e);
            });
            var handlePointerMove = function handlePointerMove(e) {
                if (resizing && _this.image) {
                    var pageX = void 0,
                        pageY = void 0;
                    if (e.touches && e.touches[0]) {
                        e.preventDefault();
                    ...
                    _this.image.setAttribute('width', Math.max(startWidth + deltaWidth, 100));
        ...
        key: "controlImage",
        value: function controlImage(image) {
            this.image = image;
            this.updatePosition();
            this.show();
        }
